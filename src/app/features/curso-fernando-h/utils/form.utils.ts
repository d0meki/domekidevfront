...
export class FormUtils {
  ...
  static isValidField(form: FormGroup, fieldName: string): boolean {
    return FormUtils.isValidControl(form.get(fieldName));
  }

  static isValidControl(control: AbstractControl | null): boolean {
    return !!control?.invalid && !!control.touched;
  }

  static getControlError(control: AbstractControl | null): string | null {
    if (!FormUtils.isValidControl(control)) return null;
