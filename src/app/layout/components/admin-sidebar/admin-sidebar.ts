  ...
  navItems: NavItem[] = [
    {
      ...
      name: 'Dashboard',
      subItems: [{ name: 'Analytics', path: '/dashboard/analytics' }],
    },
    {
      name: 'Curso Fernando H.',
      ...
      subItems: [
        ...
        { name: 'Custom Pipe', path: '/bases/custom-pipe-example', pro: false },
        { name: 'Form Basic', path: '/bases/forms-basic', pro: false },
        { name: 'Form Dynamic', path: '/bases/forms-dinamic', pro: false },
